...
import { Body, Caption2, Title1 } from "../common/Text";
import { Colors } from "../theme/Colors";
import { SCREEN_WIDTH, Size, SizeV2 } from "../theme/Size";
import { Button, ErrorMessage, SecondaryButton, SupportLink } from "../common";
